...
5. `docs/governance/ARTIFACT_PROTOCOL_V2.md`
6. `docs/architecture/MASTER_ARCHITECTURE_V2.md`
7. `docs/state/OPEN_QUESTIONS.yaml`
8. `docs/state/DEFERRED_DECISIONS.yaml`
