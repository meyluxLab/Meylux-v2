...
```text
STEP-P0-001  Constitution ratification
STEP-P0-002  Architecture reconciliation
...
Golden vectors are mandatory for critical deterministic algorithms. They are generated by actual execution and pinned only after verification.
